...
| `analyticworker.container`                    | Docker image URL for the analyticworker resource                                                                                                                                        | `registry.semaforprogam.com/medifor/analytic-worker analyticworker:develop`                                  |
...
| `ui.container`                                | Docker image URL for the UI resource                                                                                                                                                    | `registry.semaforprogam.com/medifor/medifor-demo-ui:develop`                                                 |
